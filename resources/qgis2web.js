...
map.getView().fit([9809668.127558, 2703237.447684, 9822064.747646, 2709588.175188], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">ETA INDEX</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (802 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'The Eta Index is another important metric in network analysis that measures the average length of links (roads) within a transportation or road network. It is calculated by dividing the total length of all links by the total number of links in the network.<br /><br />This index provides insight into the typical distance between intersections or junctions. A higher Eta Index indicates longer average road segments, which may suggest more direct routes or less dense networks. In contrast, a lower Eta Index reflects shorter road segments, typically found in more compact or highly connected networks.<br /><br />Areas with high Eta Index values—indicating longer, more direct road segments—are represented in dark blue.<br /><br />Areas with low Eta Index values—reflecting shorter, more fragmented road segments—appear in yellow.';
            }
